/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8976d26b58af0160f92598b7b9e27a80)
// Runtime types generated with workerd@1.20260301.1 2025-03-01 nodejs_als,nodejs_compat
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    PLUNK_BASE_URL: string;
    PLUNK_SECRET_KEY: string;
    PUBLIC_EMAIL_VERIFICATION_TIMEOUT_MINUTES: string;
    ORIGIN: string;
    HOST: string;
    PORT: string;
    BUILD_DATABASE_URL: string;
