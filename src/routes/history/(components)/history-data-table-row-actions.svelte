                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="font-semibold"
                                class:text-green-700={row.original.status ===
                                    "paid"}
                                class:text-red-700={row.original.status !==
                                    "paid"}
                            >
                                {row.original.status}
                            </span>
                        ...
                        {#if row.original.subReadingLatest}
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono"
                                    >{row.original.subReadingLatest}</span
                                >
                            </div>
                        {/if}
                        ...
                        {#if row.original.subReadingOld}
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono"
                                    >{row.original.subReadingOld}</span
                                >
                            </div>
                        {/if}
                        ...
                        {#if row.original.subPaymentId}
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono"
                                    >{row.original.subPaymentId}</span
                                >
                            </div>
                        {/if}
                    </div>
    ...
    {#if active_dialog_content === "remove"}
        <Dialog.Content>
            <Dialog.Header>
                ...
                <Dialog.Description>
                    Are you sure you want to remove this billing info record?
            ...
            <Dialog.Footer>
                ...
                >
                    {#if app_state === "processing"}
                        ...
                        Removing
                        <span class="ml-1">
                            <span class="animate-pulse animation-delay-0"
                                >.</span
                            >
                            <span class="animate-pulse animation-delay-500"
                                >.</span
                            >
                            <span class="animate-pulse animation-delay-1000"
                                >.</span
                            >
                        </span>
                    {:else}
