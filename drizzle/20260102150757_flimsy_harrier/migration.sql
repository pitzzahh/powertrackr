ALTER TABLE `user` RENAME COLUMN `githubId` TO `github_id`;--> statement-breakpoint
...
ALTER TABLE `user` ADD `recovery_code` blob;--> statement-breakpoint
ALTER TABLE `user` ADD `registered_two_factor` integer DEFAULT false NOT NULL;--> statement-breakpoint
...
INSERT INTO `__new_billing_info`(`id`, `user_id`, `date`, `total_kwh`, `sub_kwh`, `balance`, `status`, `pay_per_kwh`, `sub_reading_latest`, `sub_reading_old`, `payment_id`, `sub_payment_id`, `created_at`, `updated_at`) SELECT `id`, `user_id`, `date`, `total_kwh`, `sub_kwh`, `balance`, `status`, `pay_per_kwh`, `sub_reading_latest`, `sub_reading_old`, `payment_id`, `sub_payment_id`, `created_at`, `updated_at` FROM `billing_info`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_user`(`id`, `github_id`, `name`, `email`, `email_verified`, `image`, `password_hash`, `created_at`, `updated_at`) SELECT `id`, `github_id`, `name`, `email`, `email_verified`, `image`, `password_hash`, `created_at`, `updated_at` FROM `user`;--> statement-breakpoint
